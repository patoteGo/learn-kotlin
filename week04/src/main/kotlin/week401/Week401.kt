...
class BinaryTree1 {
    ...
    //     class Node {} // default is public final
...
class BinaryTree2 {
    fun printValue(value: Int) { // member function of BynaryTree3
        println(value)
    }
    private val dummyNode = Node(0)
    private var root = dummyNode
    ...
    private data class Node(val value: Int) {
        ...
        //    does not have access to data/functions in container class
        fun inorder() {
            // printValue(value) // cannot call - does not have access to container class
        }
    }
    fun insert(value: Int) {
        root = Node(value)
...
fun main() {
    ...
    //    val node = BinaryTree3.Node() // cannot create instance of inner class from outside container class
}
